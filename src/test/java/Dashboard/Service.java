...
public class Service extends TestBase {
    ...
    @Test(priority = 0)
    public void navigate_To_Service(){
//        href="http://stars.neop.co/admin/categories/1/edit"
        WebElement categoriesLink = driver.findElement(By.xpath("//a[@href='http://stars.neop.co/admin/services']"));
        categoriesLink.click();
        String expectedResult="http://stars.neop.co/admin/services";
        String actualResult = driver.getCurrentUrl();
        Assert.assertEquals(actualResult,expectedResult);
    }
    @Test(priority = 1)
    public void create_Service() throws InterruptedException {
        WebElement addServiceLink = driver.findElement(By.xpath("/html[1]/body[1]/main[1]/div[1]/div[1]/div[1]/div[1]/div[1]/div[1]/p[1]/a[1]/button[1]"));
        Thread.sleep(100);
    ...
    @Test(priority = 3)
    public void RestoreService() throws InterruptedException {
        driver.navigate().to("http://stars.neop.co/admin/services");
        Thread.sleep(1000);
